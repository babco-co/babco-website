      ...
      <nav className="w-full flex items-center justify-between">
        <div className="flex items-center justify-start gap-3">
          <svg
            ...
            fill="none"
          >
            <circle cx="19" cy="19" r="19" fill="#FFC0F1" />
            <path
          ...
          <p className="text-xs font-normal text-primary-white uppercase">
        ...
        <div className="flex items-center justify-end gap-5">
          <Link
            className="text-xs font-normal text-primary-white uppercase"
            href={
